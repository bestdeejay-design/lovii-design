...
**Version 1.0.0** · канон: lovii.mobiap.com · обновлено 2026-09-04 · [CHANGELOG](CHANGELOG.md)
...
| `SKILL.md` | Заготовка скила для агента-дизайнера |
...
- **v1.0 (текущая)** — токены: цвет, типографика, пространство/форма/движение, темы, применение
- **v1.1** — решение по таблице расхождений (dark-альфы soft-токенов, dark-тени), сик-патчи
- **v2** — компоненты: анатомия кнопок/чипов/карточек/шитов, состояния, код-сниппеты
