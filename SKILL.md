...
7. `examples/01…06.html` — **референс-экраны по ролям + UX-лаборатория** (готовые страницы, обе темы)
8. `docs/08-recipes.md` — пошаговые рецепты типовых задач (новый экран, новый токен, приёмка…)
9. `style-guide.html` — визуальный эталон (открыть в браузере, переключить тему)
10. `docs/checklist.md` — приёмка перед завершением
...
Не ролевой референс: `examples/06-ux-lab.html` — UX-лаборатория (живые демо scroll/адаптив/PWA/hash-роутинга, docs/10).
