...
|---|---|---|---|---|
| 1 | dark `soft-pink/tiffany/gold` | α .12 / .12 / .16 | α .20 / .18 / .20 (×~1.6 «иначе теряют контраст») | ⚠ Требует решения: либо мердж в канон (v1.1), либо приведение site к канону. До решения новые экраны демки используют канон |
| 2 | dark `mist-pink` | .06 | .10 | ⚠ Аналогично #1 |
| 3 | dark тени soft/lift | те же, что light | `rgba(0,0,0,.45)/.55` (глубже) | ⚠ Кандидат в канон — на тёмном «сливовая» тень слабо видна |
