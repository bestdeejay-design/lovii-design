...
**Version 1.9.1** · канон: lovii.mobiap.com · обновлено 2026-09-04 · [CHANGELOG](CHANGELOG.md)
...
| `examples/` | **Референс-экраны по ролям**: 01 клиент · 02 бизнес · 03 партнёр · 04 амбассадор · 05 инвестор · **06 UX-лаборатория (живые паттерны v3)** · **07 Тон-лаборатория (голос и тексты v4)** · **08 Библиотека компонентов (полный набор v5)** (готовые HTML, обе темы) |
