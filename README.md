...
**Version 1.4.0** · канон: lovii.mobiap.com · обновлено 2026-09-04 · [CHANGELOG](CHANGELOG.md)
...
| `examples/` | **Референс-экраны по ролям**: 01 клиент · 02 бизнес · 03 партнёр · 04 амбассадор · 05 инвестор · **06 UX-лаборатория (живые паттерны v3)** (готовые HTML, обе темы) |
